...
if (isset($_GET['q'])) {
    ...
    // Retrieve archived data based on the search query
    $query = "SELECT * FROM archive_table WHERE date LIKE '%$search_query%' ORDER BY date DESC";
    ...
    <html>
    <head>
        <title>Archived Search Results</title>
...
<form class="search" action="archived_search.php" method="get">
  ...
  <div class="content">
    ...
    header("Location: archived_data.php");
    exit();
}
?>
