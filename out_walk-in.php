...
<body>
    <form class="container card" method="post" action="update_timeout_walk-in.php">
        <h3>Logout</h3>
        <div class="form-group">
            <label for="name">Name:</label>
            <input type="text" name="name" id="name" placeholder="Juan Dela Cruz" required><br>
        </div>

        <div class="form-group">
            <label for="logout_time">Logout Time:</label>
            <input type="time" name="logout_time" required><br>
        </div>
